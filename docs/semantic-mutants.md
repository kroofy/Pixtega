...
| 15 | emit a strong derived ETag from a weak upstream tag | `response_tests::weak_upstream_etag_stays_weak_on_the_derived_tag`, `response_tests::filesystem_etag_is_weak` |
